...
class AtOnboardingLocalizations {
  ...
  String get error_atSign_activated {
    return Intl.message(
      'This Endpoint has already been activated. Please upload your key files to pair it with this device',
  ...
  String get msg_atSign_unreachable {
    return Intl.message(
      'Your Endpoint and the server is unreachable. Please try again or contact support@atsign.com',
  ...
  String get pair_atSign {
    return Intl.message(
      'Pair an Endpoint using your key files',
      name: 'pair_atSign',
      desc: '',
      args: [],
    );
  ...
  String get sub_upload_atKeys {
    return Intl.message(
      'Upload your key file. This file was generated when you activated and paired your Endpoint and you were prompted to store it in a secure location.',
  ...
  String get tutorial_upload_your_atKey {
    return Intl.message(
      'If you have an activated Endpoint, tap to upload your key files',
...
class AppLocalizationDelegate
  ...
  List<Locale> get supportedLocales {
    return const <Locale>[
      ...
      Locale.fromSubtags(
          languageCode: 'zh', scriptCode: 'Hans', countryCode: 'CH'),
      Locale.fromSubtags(
